...
public class TestEventPullSources {
  ...
  static public class AEXStocksEventPullSource extends EventPullSource {
    ...
    String[] stocks = { "abn amro", "26", "aegon", "38", "ahold", "34", "akzo nobel", "51", "asm lith h", "26",
        "corus plc", "2", "dsm", "40", "elsevier", "14", "fortis (nl)", "32", "getronics", "6", "gucci", "94",
        "hagemeyer", "25", "heineken", "61", "ing c", "78", "klm", "66", "kon olie", "66", "kpn", "13", "numico c",
        "44", "philips, kon", "38", "tnt", "26", "unilever c", "62", "vendex kbb", "16", "vnu", "49", "wolt-kluw c",
        "25" };
  ...
  static public class WebPresentationEventPullSource extends EventPullSource {
    ...
    String[] slideURLs = { "ejb/j2ee/ejbover/slide.0.0.html", "ejb/j2ee/ejbover/slide.0.1.html",
        "ejb/j2ee/ejbover/slide.0.2.html", "ejb/j2ee/ejbover/slide.0.3.html", "ejb/j2ee/ejbover/slide.0.4.html" };
...
/*
 * $Log: TestEventPullSources.java,v $ Revision 1.10 2007/11/09 13:16:57 justb
 ...
 * compact)
 * 
 * Revision 1.6 2005/02/18 09:54:15 justb refactor: rename Publisher
 * Dispatcher.getInstance(). and single Subscriber class
 * 
 * Revision 1.5 2004/09/03 22:35:37 justb Almost complete rewrite, just checking
 * in now
 * 
 * Revision 1.4 2003/12/03 21:16:58 justb *** empty log message ***
 * 
 ...
 * 
 * Revision 1.1.1.1 2002/09/20 22:48:19 justb import to SF
 * 
 * Revision 1.1.1.1 2002/09/20 14:19:01 justb first import into SF
 * 
 * Revision 1.6 2002/07/29 10:17:22 just no message
 * 
 * Revision 1.5 2001/02/18 23:45:13 just fixes for AEX
 * 
 * Revision 1.4 2000/10/30 14:16:09 just no message
 * 
