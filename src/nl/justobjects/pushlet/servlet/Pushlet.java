...
/*
 * $Log: Pushlet.java,v $ Revision 1.23 2007/12/04 13:55:53 justb reimplement
 * SessionManager concurrency (prev version was not thread-safe!)
 * 
 * Revision 1.22 2007/11/24 10:29:36 justb add hooks for custom logging (you can
 * override DefaultLogger in pushlet.properties)
 * 
 * Revision 1.21 2007/11/23 21:10:17 justb add hooks for custom logging (you can
 * override DefaultLogger in pushlet.properties)
 * 
 * Revision 1.20 2007/11/10 13:44:02 justb pushlet.properties and
 * sources.properties can now also be put under WEB-INF
 * 
 * Revision 1.19 2006/05/15 11:52:53 justb updates mainly for AJAX client
 * 
 * Revision 1.18 2005/02/28 15:58:05 justb added SimpleListener example
 * 
 * Revision 1.17 2005/02/28 13:06:01 justb introduced join-listen protocol
 * service
 * 
 * Revision 1.16 2005/02/28 12:45:59 justb introduced Command class
 * 
 * Revision 1.15 2005/02/28 09:14:56 justb sessmgr/dispatcher factory/singleton
 * support
 * 
 * Revision 1.14 2005/02/25 15:13:04 justb session id generation more robust
 * 
 * Revision 1.13 2005/02/21 17:19:21 justb move init()/destroy() to Pushlet
 * servlet
 * 
 * Revision 1.12 2005/02/21 16:59:17 justb SessionManager and session lease
 * introduced
 * 
 * Revision 1.11 2005/02/21 11:50:47 justb ohase1 of refactoring Subscriber into
 ...
 * compact)
 * 
 * Revision 1.8 2005/01/13 14:47:15 justb control evt: send response on same
 * (control) connection
 * 
 * Revision 1.7 2004/10/24 12:58:18 justb revised client and test classes for
 * new protocol
 * 
 * Revision 1.6 2004/09/26 21:39:44 justb allow multiple subscriptions and
 * out-of-band requests
 * 
 * Revision 1.5 2004/09/20 22:01:40 justb more changes for new protocol
 * 
 * Revision 1.4 2004/09/03 22:35:37 justb Almost complete rewrite, just checking
 * in now
 * 
 * Revision 1.3 2004/08/13 23:36:06 justb rewrite of Pullet into Pushlet "pull"
 * mode
 * 
 * Revision 1.2 2003/08/15 08:37:40 justb fix/add Copyright+LGPL file headers
 * and footers
 * 
 * Revision 1.1 2003/08/13 13:26:57 justb moved all servlets to servlet package
 * 
